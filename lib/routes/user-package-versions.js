...
module.exports = function (imports) {
  ...
  app.get('/:username/:package/:version/:file', function (req, res) {
    ...
    // TODO: (these are handled in Package model)
    //  handle "/username/package/latest/file.html"
    //  handle "/username/package/dev/file.html" (use Package.findFileContentsByPackageIdOrName)
    ...
    Package.getVersion({
      ...
      // TODO: handle if there is no gist_id
      ...
      gh.getGistFileContentsForCommit(gistId, sha, function (err, files) {
        ...
        if (!files[filename]) return res.send(404);
