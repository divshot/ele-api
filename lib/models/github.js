...
Github.prototype.hostWithClient = function (uri) {
  return this._host + uri + '?client_id=' + process.env.GITHUB_KEY + 'client_secret=' + process.env.GITHUB_SECRET;
};
...
// Useful for overriding while testing
Github.prototype._request = function (options, done) {
